...
<div class="max-w-7xl mx-auto py-12 px-6">
    ...
    <!-- Navigation & Actions -->
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-24 animate-fade-in">
        ...
        <div class="flex gap-4">
            <a href="/edit/{{ $recipe->id }}" class="px-8 py-3 rounded-full border border-white/20 font-bold hover:bg-emerald-500 hover:border-emerald-500 transition-all">
                Edit Record
            </a>
